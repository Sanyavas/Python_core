...
class Record:
    ...
    def __repr__(self):
        return f"name: {self.name}, phone: {self.phones}, email: {self.email}, birthday: {self.birthday}"
...
def start_info():
    return f"Hello I'm console bot, I was created to record contacts.\n" \
           f"I know this commands: >hello< >add<, >change<, >show<, >phone<, >del<, >birt<, >email<, >sear<" \
